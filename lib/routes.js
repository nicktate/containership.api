...
exports.register = function(server, middleware) {
    ...
    // api get plugins
    server.get('/:api_version/plugins', middleware.get_handler('plugins', 'get'), middleware.handle_response);

    // api install plugin
    server.post('/:api_version/plugins/:plugin', middleware.get_handler('plugins', 'create'), middleware.handle_response);

    // api delete plugin
    server.delete('/:api_version/plugins/:plugin', middleware.get_handler('plugins', 'delete'), middleware.handle_response);
};
